...
@testitem "PluginsCollection" begin 
    ...
    @test @inferred(PluginsCollection() + APluginOfArbitraryPluginType1() + APluginOfArbitraryPluginType2()) === PluginsCollection((APluginOfArbitraryPluginType1(), APluginOfArbitraryPluginType2()))
    @test @inferred(PluginsCollection(APluginOfArbitraryPluginType1(), APluginOfArbitraryPluginType2())) === PluginsCollection((APluginOfArbitraryPluginType1(), APluginOfArbitraryPluginType2()))
    ...
    @test collect(PluginsCollection((APluginOfArbitraryPluginType1(), APluginOfArbitraryPluginType2()))) == [ APluginOfArbitraryPluginType1(), APluginOfArbitraryPluginType2() ]
