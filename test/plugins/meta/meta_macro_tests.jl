@testitem "check_for_returns" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, check_for_returns_meta) input
...
@testitem "add_meta_constructor" setup = [TestUtils] begin
    using MacroTools
    ...
    TestUtils.@test_expression_generating add_meta_construction(input) output
...
@testitem "create_submodel_meta" setup = [TestUtils] begin
    using MacroTools
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, create_submodel_meta) output
...
@testitem "convert_meta_variables" setup = [TestUtils] begin
    using MacroTools
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_meta_variables) output
...
@testitem "convert_meta_object" setup = [TestUtils] begin
    using MacroTools
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_meta_object) output
...
@testitem "meta_macro_interior" setup = [TestUtils] begin
    using MacroTools
    ...
    TestUtils.@test_expression_generating meta_macro_interior(input) output
