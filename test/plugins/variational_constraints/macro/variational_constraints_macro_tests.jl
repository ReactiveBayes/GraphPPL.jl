@testitem "check_reserved_variable_names_constraints" setup = [TestUtils] begin
...
@testitem "check_for_returns" setup = [TestUtils] begin
    ...
    output = input
    TestUtils.@test_expression_generating apply_pipeline(input, check_for_returns_constraints) output
...
@testitem "add_constraints_construction" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating add_constraints_construction(input) output
...
@testitem "rewrite_stacked_constraints" setup = [TestUtils] begin
    ...
    output = input
    TestUtils.@test_expression_generating apply_pipeline(input, rewrite_stacked_constraints) output
...
@testitem "stack_constraints" setup = [TestUtils] begin
...
@testitem "replace_begin_end" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, replace_begin_end) output
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, replace_begin_end) input
...
@testitem "create_submodel_constraints" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, create_submodel_constraints) output
...
@testitem "create_factorization_split" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, create_factorization_split) output
...
@testitem "create_factorization_combinedrange" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, create_factorization_combinedrange) output
end

@testitem "convert_variable_statements" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_variable_statements) output
...
@testitem "convert_functionalform_constraints" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_functionalform_constraints) output
...
@testitem "convert_message_constraints" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_message_constraints) output
end

@testitem "convert_factorization_constraints" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating apply_pipeline(input, convert_factorization_constraints) output
...
@testitem "constraints_macro_interior" setup = [TestUtils] begin
    ...
    TestUtils.@test_expression_generating constraints_macro_interior(input) output
end

@testitem "constraints_macro" setup = [TestUtils] begin
