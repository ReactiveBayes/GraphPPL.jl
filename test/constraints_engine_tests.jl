...
@testitem "ResolvedFactorizationConstraint" begin
    ...
    let constraint = ResolvedFactorizationConstraint(
            ...
            (
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 2, __context__),)),
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 3, __context__),))
            )
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1, 3], [2, 3], [1, 2, 3]])
    end

    let constraint = ResolvedFactorizationConstraint(
            ResolvedConstraintLHS((ResolvedIndexedVariable(:w, 4:5, __context__),)),
            (
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 4, __context__),)),
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 5, __context__),))
            )
        )
        @test !GraphPPL.is_applicable(__model__, __normal_node__, constraint)
    end
    ...
    let constraint = ResolvedFactorizationConstraint(
            ResolvedConstraintLHS((ResolvedIndexedVariable(:w, 2:3, __context__),)),
            (ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, SplittedRange(2, 3), __context__),)),)
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1, 3], [2, 3], [1, 2, 3]])
    end
    ...
    let constraint = ResolvedFactorizationConstraint(
            ResolvedConstraintLHS((ResolvedIndexedVariable(:w, 2:3, __context__), ResolvedIndexedVariable(:y, nothing, __context__))),
            (
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, SplittedRange(2, 3), __context__),)),
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:y, nothing, __context__),))
            )
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1], [2], [3]])
    end
    ...
    let constraint = ResolvedFactorizationConstraint(
            ...
            (
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 2, __context__),)),
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, 3, __context__), ResolvedIndexedVariable(:y, nothing, __context__)))
            )
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1], [2, 3], [2, 3]])
        apply!(__model__, __normal_node__, constraint)
        @test GraphPPL.factorization_constraint(__model__[__normal_node__]) == BitSetTuple([[1], [2, 3], [2, 3]])
    end

    let constraint = ResolvedFactorizationConstraint(
            ResolvedConstraintLHS((ResolvedIndexedVariable(:w, 2:3, __context__), ResolvedIndexedVariable(:y, nothing, __context__))),
            (
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:w, CombinedRange(2, 3), __context__),)),
                ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:y, nothing, __context__),))
            )
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1, 2], [1, 2], [3]])
    end
    ...
    let constraint = ResolvedFactorizationConstraint(
            ...
            (ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:x, SplittedRange(CartesianIndex(1, 1), CartesianIndex(3, 3)), __context__),)),)
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1, 3], [2, 3], [1, 2, 3]])
        apply!(__model__, __normal_node__, constraint)
        @test GraphPPL.factorization_constraint(__model__[__normal_node__]) == BitSetTuple([[1, 3], [2, 3], [1, 2, 3]])
    end
    ...
    let constraint = ResolvedFactorizationConstraint(
            ResolvedConstraintLHS((ResolvedIndexedVariable(:x, nothing, __context__),),),
            (ResolvedFactorizationConstraintEntry((ResolvedIndexedVariable(:x, CombinedRange(CartesianIndex(1, 1), CartesianIndex(3, 3)), __context__),)),)
        )
        @test GraphPPL.is_applicable(__model__, __normal_node__, constraint)
        @test GraphPPL.convert_to_bitsets(__model__, __normal_node__, constraint) == BitSetTuple([[1, 2, 3], [1, 2, 3], [1, 2, 3]])
        apply!(__model__, __normal_node__, constraint)
        @test GraphPPL.factorization_constraint(__model__[__normal_node__]) == BitSetTuple([[1, 2, 3], [1, 2, 3], [1, 2, 3]])
    end
end
